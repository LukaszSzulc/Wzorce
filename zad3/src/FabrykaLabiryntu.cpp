...
Komorka* FabrykaLabiryntu::TworzKomorke(int indeks) const
{
	return new Komorka(indeks);
}

Drzwi* FabrykaLabiryntu::TworzDrzwi(int indekskomorki1, int indekskomorki2) const
{
...
Labirynt* StandardowaFabrykaLabiryntu::TworzLabirynt() const
{
