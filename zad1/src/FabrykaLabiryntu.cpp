...
Komórka* FabrykaLabiryntu::TwórzKomórkę(int indeks) const
{
	return new Komórka(indeks);
}

Drzwi* FabrykaLabiryntu::TwórzDrzwi(int indeksKomórki1, int indeksKomórki2) const
{
	return new Drzwi(indeksKomórki1, indeksKomórki2);
}

//---------------------

Labirynt* StandardowaFabrykaLabiryntu::TwórzLabirynt() const
{
